...
interface PlotProps {
  ...
  onSelect?: () => void;
  onShowInfo?: (plotData: PlotData) => void;
}

export function Plot({ plot, isSelectable = false, onSelect, onShowInfo }: PlotProps) {
  const { user } = useUser();
  ...
  const handlePlotClick = () => {
    if (isSelectable && onSelect) {
      ...
      console.log('Plot clicked, showing info modal');
      onShowInfo(plot);
    }
  };
